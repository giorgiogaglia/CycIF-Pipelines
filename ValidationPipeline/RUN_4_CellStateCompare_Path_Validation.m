function RUN_4_CellStateCompare_Path_Validation(basefolder, folders, dates,marker_name, antibody_rounds, marker_cycle, HSF1round, canceround, antibody_type, sol_thresh) 
...
openfile = [basefolder folders{folder} dates folders{folder} '_Results.mat'];
load(openfile)

openfile = 'Incorrect_ROIs.mat'; 
load(openfile)
bad_fields = ROI_Fields(folder).NotCancer;    %Vector of fields that are not Cancer tissue 
