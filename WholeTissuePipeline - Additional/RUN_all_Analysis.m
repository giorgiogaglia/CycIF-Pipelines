...
RUN_2_segmentstacks_append(basefolder, slides_folders, maxfields,DAPIslice, options, max_rows, well_nums, well_lets)
disp('Run 3: Foci Segmentation & making Measurements')
RUN_3_CycIF_measurements_append(basefolder,slides_folders, maxfields, maxcycle, dates, DAPIslice, z_cycle, z_num, thr, CYCLEslice, prefix1,max_rows, well_nums, well_lets, cycles)
if ~isempty(montfols)
    disp('Removing ROIs')
