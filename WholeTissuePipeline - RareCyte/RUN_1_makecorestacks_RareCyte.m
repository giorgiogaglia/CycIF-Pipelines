function RUN_1_makecorestacks_RareCyte(master_folderIN, basefolder,basicfolderloc, slides_folders, maxfields, cycles, tilesize, prefix1, wavelengths, z_wave, z_cycle,z_num, max_rows, well_nums , well_lets, DAPIwv)
